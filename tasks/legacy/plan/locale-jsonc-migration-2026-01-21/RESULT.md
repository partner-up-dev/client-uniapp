...
Status: Completed for global JSONC bundles, component/page migration deferred.

Current note: i18n usage guidance now supports useTranslate for domain/global keys and useI18n for local messages. Refer to AGENTS.md and src/locale/AGENTS.md for the current convention.
